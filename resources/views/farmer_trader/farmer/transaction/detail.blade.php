	...
	<div class="row">
		...
		<div class="breadcrumbs d-flex flex-row align-items-center">
			<ul>
				...
				<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Chi tiết Giao dịch</a></li>
			</ul>
		</div>
		<ul>
			<li>
				<a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false"  style="margin: 20px 0px">
					Thông tin khách hàng					
				</a>
				<div class="collapse" id="collapseExample">
					<div class="card card-body">
						<ul>
							<li><b>Người mua hàng: </b> 
